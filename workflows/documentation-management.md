...
**CRITICAL - Multi-Project Workspace:**
...
Save plans in `<PROJECT_ROOT>/plans` directory with timestamp and descriptive name.

**Format:** `<PROJECT_ROOT>/plans/YYYYMMDD-HHmm-your-plan-name/`

**Example:** `my-app/plans/20251101-1505-authentication-and-profile-implementation/`
