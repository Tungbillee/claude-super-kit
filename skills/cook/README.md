...
```bash
/sk:cook <natural language task OR plan path>
```
...
/sk:cook implement user authentication

# Execute existing plan
/sk:cook plans/260120-auth

# Fast mode (skip research)
/sk:cook quick fix for login bug
/sk:cook implement feature --fast

# Auto mode (trust me bro)
/sk:cook implement dashboard trust me
/sk:cook implement feature --auto

# Parallel mode (multi-agent)
/sk:cook implement auth, payments, notifications
/sk:cook implement feature --parallel

# No-test mode
/sk:cook implement feature --no-test
```
