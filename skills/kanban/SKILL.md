...
- `/sk:kanban` - View dashboard for ./plans directory
- `/sk:kanban <dir>` - View dashboard for specific directory
- `/sk:kanban --stop` - Stop running server
...
The `/sk:kanban` command will evolve into **VibeKanban-inspired** AI agent orchestration:
