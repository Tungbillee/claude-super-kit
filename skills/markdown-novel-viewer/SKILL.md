...
**Note:** HTML generation mode (`/sk:preview --html ...`) produces self-contained HTML files that open directly in the browser — they do not use this server.
...
Use `/sk:preview` for quick access:

```bash
/sk:preview plans/my-plan/plan.md    # View markdown file
/sk:preview plans/                   # Browse directory
/sk:preview --stop                   # Stop server
```
