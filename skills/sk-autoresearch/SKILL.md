...
# sk:autoresearch — Autonomous Optimization Loop
...
|-----------|-------------|
| Subjective goals ("make it cleaner") | `sk:cook` |
| Bug fixing with known root cause | `sk:fix` or `sk:debug` |
| One-shot tasks, no repetition needed | `sk:cook` |
| No mechanical metric to measure progress | `sk:cook --interactive` |
