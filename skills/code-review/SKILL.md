...
| **Checklist review** | Pre-landing, `/sk:ship` pipeline, security audit | `references/checklist-workflow.md` |
...
**Process:**
1. Invoke `/sk:scout` with edge-case-focused prompt
...
|------------|-----------|---------|
| `/sk:code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/sk:code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
