...
- `sk:plan` — Creates implementation plans (planning phase)
- `sk:cook` — Implements plans (execution phase, invokes project-manager at finalize)
