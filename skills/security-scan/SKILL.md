...
```
/sk:security-scan              # Full scan of current project
/sk:security-scan --secrets-only   # Only secret/credential detection
/sk:security-scan --deps-only      # Only dependency audit
/sk:security-scan src/api/         # Scan specific directory
```
