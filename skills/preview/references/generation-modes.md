...
When generating mermaid code blocks, use `/sk:mermaidjs-v11` skill for v11 syntax rules.
...
For `--slides`: recommend invoking `/sk:ui-ux-pro-max` for richer style selection.
Must use `/sk:mermaidjs-v11` for any Mermaid diagrams.
