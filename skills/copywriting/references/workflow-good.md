...
1. **Screenshots provided** → Use `sk:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `sk:ai-multimodal` video-analysis for comprehensive context
