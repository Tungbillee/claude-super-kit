...
6. **Red Team Review** → Run `/sk:plan red-team {plan-path}` (hard/parallel/two modes)
7. **Post-Plan Validation** → Run `/sk:plan validate {plan-path}` (hard/parallel/two modes)
...
|------------|-----------|---------|
| `/sk:plan archive` | `references/archive-workflow.md` | Archive plans + write journal entries |
| `/sk:plan red-team` | `references/red-team-workflow.md` | Adversarial plan review with hostile reviewers |
| `/sk:plan validate` | `references/validate-workflow.md` | Validate plan with critical questions interview |
