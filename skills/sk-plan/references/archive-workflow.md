...
### Step 2: Summarize the plans and document them with `/sk:journal` skill invocation
...
- Stage and commit the changes (Use `/sk:git` for commit flow)
- Commit and push the changes (Use `/sk:git` for push flow)
