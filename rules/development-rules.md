...
## Visual Aids
- Use `/sk:preview --explain` when explaining unfamiliar code patterns or complex logic
- Use `/sk:preview --diagram` for architecture diagrams and data flow visualization
- Use `/sk:preview --slides` for step-by-step walkthroughs and presentations
- Use `/sk:preview --ascii` for terminal-friendly diagrams (no browser needed to understand)
